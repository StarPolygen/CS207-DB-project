...
public class GT {
    ...
    private static final String USER_AGENT = "Mozilla/5.0";// "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6)
    ...
    public String translateText(String text, String sourceLang, String targetLang) throws Exception {
        ...
        JSONArray jsonObject = JSONArray.fromObject(resp);
    ...
    /**
     * post 请求 @param url 请求地址 @param nvps 参数列表 @return @throws
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println( g.translateText("hello","en","zh-cn"));
    }
}